...
namespace FitnessProject2.Data.Migrations
{
    ...
    [Migration("20240523165928_UserRateLinkedWithChallenge")]
    partial class UserRateLinkedWithChallenge
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Participation", b =>
                {
                    b.HasOne("Challenge", null)
                        .WithMany("ParticipationsList")
                        .HasForeignKey("ChallengeId");

                    b.HasOne("Challenge", "Challenge")
                        .WithMany("Participations")
                        .HasForeignKey("ChallengeNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Challenge", b =>
                {
                    ...
                    b.Navigation("ParticipationsList");
